...
def main():
    ...
    dicExm = {"key1" : intExm, "key2" : floatExm, "key3" : strExm, "key4" : listExm, "key5" : multLstExm}
    # Values can be any data type, keys must be immutable data types, here I used string
    tupExm = (intExm, floatExm, strExm) # Tuples are immutable but the values do not need be the same
